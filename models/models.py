...
class Users(BaseModel):
    ...
    def check_user_limit(self, user_UID: str) -> int:
        ...
        Метод возвращает -1, если не найден пользователь с заданным UID
        """
    ...
    def add_user(self, user_UID: str) -> str:
        ...
        Метод возвращает сообщение об успешности операции, оповещая, если пользователь с данным UID уже создан 
        """
        check_user_already_created_query = db.select(self.table).where(self.table.c.UID == user_UID)
    ...
    def dec_user_limit(self, user_UID: str) -> str:
        ...
        Метод возвращает сообщение об успешности операции, оповещая, если данный пользователь уже имеет нулевой лимит запросов 
        """
    ...
    def reset_users_limits(self) -> None:
        ...
        Метод устанавливает всем пользователям дневной лимит в дефолтное значение 
        """
        default_limit = 80
...
class Tokens(BaseModel):
    ...
    def get_tikers(self) -> typing.List[str]:
        ...
        Метод возвращает массив, содержащий тикеры всех отслеживаемых криптовалют 
        """
    ...
    def get_tiker_by_token_ID(self, token_ID: int) -> str:
        ...
        Метод принимает id криптовалюты и возвращает тикер данной криптовалюты, если такая есть, иначе возвращает соответствующее сообщение 
        """
...
class UsersTokens(BaseModel):
    ...
    def get_users_by_token(self, token_ID: int) -> typing.List[str]:
        ...
        Метод принимает token_ID и возвращает список UID пользователя, которые подписаны на этот токен 
        """
    ...
    def get_tokens_by_user(self, user_UID: str) -> typing.List[int]:
        ...
        Метод принимает UID пользователя и возвращает список id криптовалют, на которые подписан данный пользователь 
        """
    ...
    def add_token_for_user(self, user_UID: str, token_ID: int) -> str:
        ...
        Метод принимает UID пользователя и id криптовалюты, на которую произошла подписка, выводя сообщение об успешности операции 
        """
        try:
    ...
    def remove_token_for_user(self, user_UID: str, token_ID: int) -> str:
        ...
        Метод принимает UID пользователя и id токена, возвращает сообщение об успешности операции 
        """
